      ...
      <div className="container mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-3xl mx-auto">
            Our team combines expertise in artificial intelligence, game
            development, and enterprise learning to create revolutionary
            training solutions.
          </p>
        </div>
...
const TeamMemberCard = ({
  ...
  return (
    <div
      className={`bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 w-[300px]
        ${
          isActive
          ...
          <div className="flex gap-3">
            {member.links.linkedin && (
              <a
                ...
                className="text-gray-500 hover:text-groq-purple transition-colors"
              >
                <Linkedin size={18} />
              </a>
            )}
...
const teamMembers: TeamMember[] = [
  ...
  //   image:
  //     "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1388&q=80",
  ...
  //   image:
  //     "https://images.unsplash.com/photo-1615109398623-41219a4607ef?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1374&q=80",
