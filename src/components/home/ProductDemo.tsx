...
const ProductDemo = () => {
  ...
  return (
    <section id="products" className="section-padding bg-groq-dark-blue relative overflow-hidden">
      {/* Background elements */}
      ...
      <div className="container mx-auto relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-display font-bold text-white mb-4">
            Experience the <span className="text-groq-purple">Future of Learning</span>
          </h2>
          <p className="text-gray-300 max-w-3xl mx-auto">
            Our interactive demos showcase how Groqify transforms traditional learning into engaging, effective gameplay.
          </p>
        </div>
    ...
    <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-xl overflow-hidden transition-all hover:transform hover:scale-105">
      <div className="relative">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end p-4">
          <h3 className="text-xl font-display font-bold text-white">{demo.title}</h3>
        </div>
          ...
          <Dialog>
            ...
            <DialogContent className="max-w-4xl">
              ...
              <div className="aspect-video bg-black rounded-md flex items-center justify-center">
                <p className="text-white/70 text-sm">Video demo would play here</p>
              </div>
            </DialogContent>
          </Dialog>
        )}
...
const mobileDemos: Demo[] = [
  {
    title: "LinguaQuest",
    description: "Language learning reimagined as an epic adventure game with AI-driven conversation practice.",
  ...
  {
    title: "CyberDefender",
    description: "Cybersecurity training delivered through an engaging tower defense gameplay experience.",
    image: "https://images.unsplash.com/photo-1548092372-0d1bd40894a3?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80",
    videoUrl: "#demo-video",
    features: [
  ...
  {
    title: "DataMaster",
    description: "Data analysis skills developed through puzzle-based gameplay and interactive challenges.",
...
const desktopDemos: Demo[] = [
  {
    title: "ProjectSim",
    description: "Project management training through immersive simulation with real-world scenarios.",
  ...
  {
    title: "SalesForce VR",
    description: "Sales training in virtual reality environments with AI-powered customer interactions.",
    image: "https://images.unsplash.com/photo-1617802690992-15d93263d3a9?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80",
    features: [
  ...
  },
  {
    ...
    description: "Leadership and management skills developed through strategic role-playing scenarios.",
