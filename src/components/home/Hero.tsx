...
const Hero = () => {
  return (
    <section
      id="hero"
      className="min-h-screen relative flex items-center bg-hero-gradient overflow-hidden"
    >
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="lg:w-1/2 space-y-6 text-center lg:text-left">
            ...
            <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto lg:mx-0">
              ...
              experiences that transform training into exciting gameplay,
            ...
            {/* <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
              ...
              <Button
                variant="outline"
                className="text-md px-6 py-6 text-white border-white/30 hover:bg-white/10 transition-all rounded-xl"
              >
                Learn More
              </Button>
            </div> */}
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center px-6 py-4 rounded-xl bg-black/30 backdrop-blur-sm border border-white/10">
                      ...
                      <p className="text-white/80 text-sm">
                        Personalized learning through advanced AI
                      </p>
                    </div>
                  </div>
                </div>
